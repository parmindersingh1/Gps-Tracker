jQuery(document).ready(function($) {
    ...
    function getAllRoutesForMap() {
        ...
        $.ajax({
            url: '/gpstracker/getallroutesformap',
            type: 'GET',
            dataType: 'json',
    ...
    function getRouteForMap() { 
        if (hasMap()) {
           ...
           var url = '/gpstracker/getrouteformap' + $('#routeSelect').val();
    ...
    function createMarker(latitude, longitude, speed, direction, distance, locationMethod, gpsTime,
        ...
        if (viewingAllRoutes) {
            ...
            gpstrackerMarker.on("click", function() {        
                var url = '/gpstracker/getrouteformap?sessionid=' + sessionID;
    ...
    function deleteRoute() {
        if (hasMap()) {
            ...
            if (answer){
                var url = '/gpstracker/deleteroute' + $('#routeSelect').val();
